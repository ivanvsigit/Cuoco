...
class ProgressBar: UIView, CAAnimationDelegate {
    ...
    fileprivate func gradientMask() -> CAGradientLayer {
        ...
        let colorTop: AnyObject = UIColor(ciColor: .gray)
        let colorBottom: AnyObject = UIColor(ciColor: .black)
    ...
    fileprivate func gradientMaskBg() -> CAGradientLayer {
        ...
        gradientLayer.frame = bounds
        gradientLayer.locations = [0.0, 1.0]
        let colorTop: AnyObject = UIColor(ciColor: .blue)
        let colorBottom: AnyObject = UIColor(ciColor: .blue)
        let arrayOfColors: [AnyObject] = [colorTop, colorBottom]
        gradientLayer.colors = arrayOfColors
